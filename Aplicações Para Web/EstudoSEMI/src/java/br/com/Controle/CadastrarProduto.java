    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         try (PrintWriter out = response.getWriter()) {
            ...
            String prodNome = request.getParameter("nomeProduto");
            Float prodValor = Float.parseFloat (request.getParameter("valorProduto"));
            Boolean prodIn = Boolean.getBoolean(request.getParameter("inProduto"));
            if ((prodNome == null || prodValor == null) && (prodNome == null || prodValor == null)) {
                response.sendRedirect("ErroPreenchimento.jsp");
                prodNome = "";
                prodValor = null;
            } else if (prodNome == null || prodValor == null) {
                response.sendRedirect("ErroPreenchimento.jsp");
                prodNome = "";
                prodValor = null;
            } else if (prodNome == null || prodValor == null) {
               ...
               Produtos produtos = new Produtos(prodNome, prodValor, prodIn);
                ProdutoDAO produtoDAO = new ProdutoDAO();

                produtoDAO.cadastrarProdutos(produtos);
                String url = "/OK.jsp";
