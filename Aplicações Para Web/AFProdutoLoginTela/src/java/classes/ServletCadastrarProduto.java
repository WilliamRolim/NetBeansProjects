...
public class ServletCadastrarProduto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Produto p = new Produto(Integer.parseInt(request.getParameter("cod_produto")), request.getParameter("nom_produto"), Float.parseFloat(request.getParameter("val_produto")), request.getParameter("in_produto"));
